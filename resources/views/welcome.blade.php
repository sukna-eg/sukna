    ...
    <section id="cta" class="cta">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          <h3 style="font-family: 'Tajawal', sans-serif">اختر منزل أحلامك</h3>
          <p style="font-family: 'Tajawal', sans-serif"> حمّل التطبيق دلوقتي وابدأ بإستكشاف العقارات .</p>
          <a class="cta-btn" href="https://play.google.com/store/apps/details?id=com.m0ustafamahm0ud.shbabeek">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-google-play" viewBox="0 0 16 16">
                <path d="M14.222 9.374c1.037-.61 1.037-2.137 0-2.748L11.528 5.04 8.32 8l3.207 2.96 2.694-1.586Zm-3.595 2.116L7.583 8.68 1.03 14.73c.201 1.029 1.36 1.61 2.303 1.055l7.294-4.295ZM1 13.396V2.603L6.846 8 1 13.396ZM1.03 1.27l6.553 6.05 3.044-2.81L3.333.215C2.39-.341 1.231.24 1.03 1.27Z"/>
              </svg>
              <span style="margin-left: 5px;vertical-align: middle;">Google Play</span>
          ...
          <a class="cta-btn" href="https://play.google.com/store/apps/details?id=com.m0ustafamahm0ud.shbabeek">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-apple" viewBox="0 0 16 16">
              ...
              <span style="margin-left: 5px;vertical-align: middle;">  App Store</span>
            </a>
        </div>
    	...
    	<div class="container">
    		<div class="row no-gutters d-flex">
    			<div class="col-md-6 col-lg-5 d-flex">
    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(landing2/images/hero.jpg);">
    				</div>
    			</div>
