                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a
                                                                                ...
                                                                                <span>{{ $subscription->user->name }}</span></a>
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <span>{{ $subscription->first_month == 1? 'Paid' : 'Not Paid' }}</span>
                                                                        </td>

                                                                        <td>
                                                                            <span>{{ $subscription->second_month == 1? 'Paid' : 'Not Paid' }}</span>
                                                                        </td>

                                                                        <td>
                                                                            <span>{{ $subscription->third_month == 1? 'Paid' : 'Not Paid' }}</span>
                                                                        </td>
                                                                            ...
                                                                            <div class="dropdown">
                                                                                ...
                                                                                <div class="dropdown-menu">
                                                                                    ...
                                                                                    {{-- <button class="dropdown-item"
                                                                                        ...
                                                                                        data-name="{{ $subscription->name }}">Delete</button> --}}
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
