                            ...
                            <form method="POST" action="{{ route("admin.plans.update",$plan->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-xl-8 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="name" value="{{ old('phone',$plan->name) }}">
                                            @error('name')
                                        ...
                                        <div class="col-xl-8 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="type" value="{{ old('type',$plan->type) }}">
                                            @error('type')
                                            <div class="text-danger">{{ $message }}</div>
                                             @enderror
                                        </div>
                                        ...
                                        <div class="col-xl-8 mb-3">
                                            ...
                                            <input type="number" class="form-control" name="counts" value="{{ old('counts',$plan->counts) }}">
                                            @error('counts')
                                            <div class="text-danger">{{ $message }}</div>
                                             @enderror
                                        </div>
