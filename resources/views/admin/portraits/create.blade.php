    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="page-titles">
            ...
            <a class="text-primary fs-13" href="{{ route('admin.portraits.index') }}" >{{  __('Partner images') }}</a>
        </div>
                                    ...
                                    <div class="col-xl-8 mb-3">
                                        ...
                                        <select class="default-select form-control wide mb-3" name="partner_id" tabindex="null">
                                            ...
                                            @foreach ($partners as $partner)
                                                <option value="{{ $partner->id }}" @selected(old('partner_id')==$partner->id)>{{ $partner->id }}</option>
                                            @endforeach
										</select>
                                        @error('partner_id')
                                            <div class="text-danger">{{ $message }}</div>
