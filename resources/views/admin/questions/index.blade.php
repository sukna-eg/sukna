<x-admin-layouts.admin-app>
    ...
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li>
                    <h5 class="bc-title">{{ __('Questions') }}</h5>
                </li>
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('Questions') }} </a></li>
            </ol>
            <a class="text-primary fs-13" href="{{ route('admin.questions.create') }}">+ Add Question</a>
        </div>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="table-responsive active-projects manage-client">
                                        <div class="tbl-caption">
                                            <h4 class="heading mb-0"> {{ __('Questions') }}</h4>
                                        </div>
                                                                            ...
                                                                            <div class="dropdown">
                                                                                ...
                                                                                <div class="dropdown-menu">
                                                                                    ...
                                                                                    <button class="dropdown-item"
                                                                                        ...
                                                                                        data-id="{{ $question->id }}"
                                                                                        data-name="{{ $question->id }}">Delete</button>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
