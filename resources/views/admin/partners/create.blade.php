                            ...
                            <form method="POST" action="{{ route('admin.partners.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-8 mb-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" id="Without" type="radio" name="cladding" value="بدون تشطيب" @checked(old('cladding')=="بدون تشطيب")>
                                            <label class="form-check-label" for="Without">
                                                Without Cladding
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" id="Half" type="radio" name="cladding" value="نصف تشطيب" @checked(old('cladding')=="نصف تشطيب")>
                                            <label class="form-check-label" for="Half">
                                                Half Cladding
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" id="Full" type="radio" name="cladding" value="تشطيب كامل" @checked(old('cladding')=="تشطيب كامل")>
                                            <label class="form-check-label" for="Full">
                                                Full Cladding
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" id="Lux" type="radio" name="cladding" value="تشطيب لوكس" @checked(old('cladding')=="تشطيب لوكس")>
                                            <label class="form-check-label" for="Lux">
                                                Lux Cladding
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" id="Super" type="radio" name="cladding" value="تشطيب سوبر لوكس" @checked(old('cladding')=="تشطيب سوبر لوكس")>
                                            <label class="form-check-label" for="Super">
                                               Super Lux Cladding
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" id="delux" type="radio" name="cladding" value="تشطيب ديلوكس" @checked(old('cladding')=="تشطيب ديلوكس")>
                                    ...
                                    <div class="col-xl-8 mb-3">
                                        ...
                                        <select class="default-select form-control wide mb-3" name="subcategory_id" tabindex="null">
                                            ...
                                            @foreach ($subcategories as $subcategory)
                                                <option value="{{ $subcategory->id }}" @selected(old('subcategory_id')==$subcategory->id)>{!! $subcategory->getTranslation('name', 'ar') !!}</option>
                                            @endforeach
										</select>
