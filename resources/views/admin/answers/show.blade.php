    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li><h5 class="bc-title">{{ $answer->id }}</h5></li>
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ $answer->id }} </a></li>
            </ol>
            <a class="text-primary fs-13" href="{{ route('admin.answers.index') }}" >{{  __('Answer') }}</a>
        </div>
