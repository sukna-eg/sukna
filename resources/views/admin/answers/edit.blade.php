    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li><h5 class="bc-title">{{ __('Edit Answer') }}</h5></li>
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{{  __('Edit Answer') }} </a></li>
            </ol>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="offcanvas-body">
                                <div class="container-fluid">
                                <h4 class="heading mb-0"> {{ __('Edit Answer') }}</h4>
                            ...
                            <form method="POST" action="{{ route("admin.answers.update",$answer->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-8 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInputfirst" name="answer_en" value="{{ old('answer_en',$answer->getTranslation('answer','en')) }}">
                                    ...
                                    <div class="col-xl-8 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInputfirst" name="answer_ar" value="{{ old('answer_ar',$answer->getTranslation('answer','ar')) }}">
                                    ...
                                    <div class="col-xl-8 mb-3">
                                        ...
                                        <select class="default-select form-control wide mb-3" name="question_id" tabindex="null">
                                            @foreach ($questions as $question)
                                                <option value="{{ $question->id }}" @selected(old('question_id',$answer->question->id)==$question->id)>{!! $question->getTranslation('question', 'ar') !!}</option>
                                            @endforeach
                                        </select>
                                        @error('question_id')
                                            <div class="text-danger">{{ $message }}</div>
