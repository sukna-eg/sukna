<x-admin-layouts.admin-app>
    ...
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li>
                    <h5 class="bc-title">{{ __('Answers') }}</h5>
                </li>
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('Answers') }} </a></li>
            </ol>
            <a class="text-primary fs-13" href="{{ route('admin.answers.create') }}">+ Add Answer</a>
        </div>
                                                            ...
                                                            <tbody>
                                                                @forelse ($data as $answer)
                                                                    <td><span>{{ $answer->getTranslation('answer', 'en') }}</span>
                                                                        ...
                                                                        <td>
                                                                            <span><a href="{{ route('admin.users.show',$answer->user->id) }}">{{ $answer->user->name }}</a></span>
                                                                        </td>
                                                                            ...
                                                                            <div class="dropdown">
                                                                                ...
                                                                                <div class="dropdown-menu">
                                                                                    ...
                                                                                    <button class="dropdown-item"
                                                                                        ...
                                                                                        data-id="{{ $answer->id }}"
                                                                                        data-name="{{ $answer->name }}">Delete</button>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.answers.destroy', 'test') }}" method="post">
                    {{ method_field('delete') }}
                    @csrf
