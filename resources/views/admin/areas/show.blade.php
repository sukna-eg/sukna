    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li><h5 class="bc-title">{{ $area->getTranslation('name', 'ar') }}</h5></li>
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ $area->getTranslation('name', 'ar') }} </a></li>
            </ol>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="offcanvas-body">
                                <div class="container-fluid">
                                <h4 class="heading mb-5"> {{ $area->getTranslation('name', 'ar') }}</h4>
