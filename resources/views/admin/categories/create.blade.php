                        ...
                        <div class="card-body p-0">
                            ...
                            <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-8 mb-3">
                                        <label for="ckeditor1" class="form-label">Card Title<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="exampleFormControlInputfirst" name="card_title" value="{{ old('card_title') }}">
                                    ...
                                    <div class="col-xl-8 mb-3">
                                        <label for="ckeditor1" class="form-label">Card Body<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="exampleFormControlInputfirst" name="card_body" value="{{ old('card_body') }}">
